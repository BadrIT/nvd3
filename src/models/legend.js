nv.models.legend = function () {
    ...
    function chart(selection) {
        selection.each(function (data) {
            ...
            if (rightAlign)
                wrap.merge(wrapEnter).attr('transform', 'translate(' + (-margin.right) + ',' + margin.top + ')');
            else
                wrap.merge(wrapEnter).attr('transform', 'translate(' + margin.left + ',' + margin.top + ')');
            ...
            if (align) {
                ...
                var seriesWidths = [];
                series.merge(seriesEnter).each(function (d, i) {
                    var legendText;
